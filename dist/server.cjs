...
${originalPost.content}`,
  ...
  app.all(["/api/metatrader", "/api/metatrader/*"], async (req, res) => {
    ...
    try {
      ...
      console.log(`[MT-PROXY] ${req.method} ${req.originalUrl} -> ${targetUrl}`);
      ...
      clearTimeout(timeout);
      console.error(`[MT-PROXY ERROR] ${req.method} ${req.originalUrl} -> ${targetUrl}:`, err.message);
