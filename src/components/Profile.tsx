...
import { MapPin, Briefcase, Award, TrendingUp, Settings, LogOut, Grid, Image, Activity, Save, CheckCircle2 as CheckCircle, ShieldAlert, Loader2, X, Maximize2, Minimize2, Globe, ChevronDown, Handshake, Clock, Check, BadgeCheck } from 'lucide-react';
